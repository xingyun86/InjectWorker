// AntiHookInjectDlg.h : interface of the CAntiHookInjectDlg class
//
/////////////////////////////////////////////////////////////////////////////
...
class CAntiHookInjectDlg :
	public CCodeDataBase,
	public CDialogImpl<CAntiHookInjectDlg>,
	public CDialogLayout<CAntiHookInjectDlg>,
	public CUpdateUI<CAntiHookInjectDlg>,
	public CMessageFilter,
	public CIdleHandler
{
public:
	enum { IDD = IDD_DIALOG_ANTIHOOKINJECT };
	...
	BEGIN_UPDATE_UI_MAP(CAntiHookInjectDlg)
	END_UPDATE_UI_MAP()

	BEGIN_MSG_MAP(CAntiHookInjectDlg)
		...
		CHAIN_MSG_MAP(CDialogLayout<CAntiHookInjectDlg>)
	...
	LRESULT OnInitDialog(HWND, LPARAM)
	{
		...
		{
			this->SetWindowText(_T("对抗钩子注入"));
			m_btnSelectAppDll.SetWindowText(_T("选择文件"));
			m_btnSuspendThreadInject.SetWindowText(_T("启动保护"));
			m_btnReleaseMemorySpaces.SetWindowText(_T("恢复保护"));
		}
